...
class FilamentViewApi {
  public:
    ...
    ChangeMaterialParameter(const flutter::EncodableMap& params, const std::string& guid) = 0;
    // Change material definition for the given entity.
    virtual std::optional<FlutterError>
    ChangeMaterialDefinition(const flutter::EncodableMap& params, const std::string& guid) = 0;
    ...
    virtual std::optional<FlutterError>
    EnqueueAnimation(const std::string& guid, int64_t animation_index) = 0;
    virtual std::optional<FlutterError> ClearAnimationQueue(const std::string& guid) = 0;
    virtual std::optional<FlutterError>
    PlayAnimation(const std::string& guid, int64_t animation_index) = 0;
    virtual std::optional<FlutterError>
    ChangeAnimationSpeed(const std::string& guid, double speed) = 0;
    ...
    virtual std::optional<FlutterError>
    SetAnimationLooping(const std::string& guid, bool looping) = 0;
    ...
    virtual std::optional<FlutterError> TurnOffCollisionChecksForEntity(const std::string& guid
    ) = 0;
    ...
    virtual std::optional<FlutterError>
    ChangeScaleByGUID(const std::string& guid, double x, double y, double z) = 0;
    virtual std::optional<FlutterError>
    ChangeTranslationByGUID(const std::string& guid, double x, double y, double z) = 0;
    virtual std::optional<FlutterError>
    ChangeRotationByGUID(const std::string& guid, double x, double y, double z, double w) = 0;
