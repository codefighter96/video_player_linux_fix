      ...
      channel.SetMessageHandler(
        [api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
          try {
            ...
            const auto& value_arg = std::get<bool>(encodable_value_arg);
            std::optional<FlutterError> output = api->SetFogOptions(value_arg);
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
      ...
      channel.SetMessageHandler(
        [api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
          try {
            ...
            std::optional<FlutterError> output =
              api->ChangeLightColorByGUID(guid_arg, color_arg, intensity_arg);
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
        ...
        [api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
          try {
            ...
            std::optional<FlutterError> output = api->ChangeLightTransformByGUID(
              guid_arg, posx_arg, posy_arg, posz_arg, dirx_arg, diry_arg, dirz_arg
            );
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
      ...
      channel.SetMessageHandler(
        [api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
          try {
            ...
            std::optional<FlutterError> output =
              api->ChangeRotationByGUID(guid_arg, x_arg, y_arg, z_arg, w_arg);
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
