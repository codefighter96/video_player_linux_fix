...
class Collidable : public Component {
  public:
    ...
    [[nodiscard]] bool GetShouldMatchAttachedObject() const { return m_bShouldMatchAttachedObject; }

    [[nodiscard]] ShapeType GetShapeType() const { return m_eShapeType; }

    [[nodiscard]] filament::math::float3 GetExtentsSize() const { return m_f3ExtentsSize; }

    [[nodiscard]] filament::math::float3 GetCenterPoint() const { return m_f3CenterPosition; }
    ...
    void SetShouldMatchAttachedObject(bool value) { m_bShouldMatchAttachedObject = value; }

    void SetShapeType(ShapeType value) { m_eShapeType = value; }

    void SetExtentsSize(const filament::math::float3& value) { m_f3ExtentsSize = value; }

    void SetCenterPoint(const filament::math::float3& value) { m_f3CenterPosition = value; }
