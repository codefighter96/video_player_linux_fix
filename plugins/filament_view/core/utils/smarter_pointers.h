...
template<typename P>
struct pointer_access<P, std::void_t<
...
/// "Smarter" pointers
/// When calling a method on a smarter pointer, it will check whether the underlying pointer is null
/// and if so, it will throw an exception.
///
